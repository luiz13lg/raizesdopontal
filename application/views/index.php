	...
	<section  id="projeto" class="row">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					<h4>
						<p style="text-align: justify;">O Projeto Cestas Agroecológicas e Solidárias “Raízes do Pontal”, surge com o objetivo de contribuir com a comercialização da produção de alimentos realizada por famílias camponesas do assentamento Gleba XV de Novembro, nos municípios de Euclides da Cunha Paulista e Rosana, no extremo Oeste do estado de São Paulo. O projeto é fruto da parceria entre pesquisadores do CEGeT (Centro de Estudos de Geografia do Trabalho) e o Setor de Produção do MST (Movimento dos Trabalhadores Rurais Sem Terra). A Cestas são comercializadas na UNESP/FCT, sendo o público consumidor a comunidades acadêmica (docentes, alunos e servidores) e comunidade local (morados da cidade de Presidente Prudente).  As Cestas são comercializadas quinzenalmente, e a divulgação do projeto é feita em página de duas redes sociais na internet e através do telefone.</p>
					</h4>
				</div>
			</div>
		</div>
